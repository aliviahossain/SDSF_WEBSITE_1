...
const phdData = [
    {
        ...
        title: "An Approach to Environmental Impact Assessment – Using Cross Impact Simulation and System Dynamics- Cases of Textile Units and Aquatic Resources"
    },
    {
        name: "Shirish Sangle",
        year: 2000,
    ...
    },
    {
        ...
        year: 2002,
        supervisor: "Dr. R.C.Sharma",
        title: "Econometric Estimation of Efficiency through Frontier System for Comparison of Private and Public Enterprises in Indian Cotton – Textile Industry with special reference to Forecasting and Planning"
    },
    {
        name: "Rubeena Sheikh",
        year: 2002,
    ...
    },
    {
        ...
        title: "Development Applications of Air Environment Management Models – Cases in Regional Environmental Planning"
    },
    {
...
function populateSupervisors() {
    ...
    supervisorsData.forEach(supervisor => {
      ...
      <div class="supervisor-contact">📞 ${supervisor.phone}</div>
      <div class="supervisor-contact">✉️ ${supervisor.email}</div>
